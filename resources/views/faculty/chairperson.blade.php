...
@section('content')
    ...
    <script type="module">
        ...
        $(document).ready(function () {
            $('#table-chairperson').DataTable({
                processing: true,
                serverSide: true,
                ajax: `{{ route('chairperson.home') }}`,
                columns: [
                    ...
                    { data: 'course_name', name: 'course_name', searchable: false},
                    {
                        data: null,
                        name: 'actions',
                        orderable: false,
            ...
            $('#table-chairperson').on('click', '.btn-deactivate', function() {
                var id = $(this).data('id');
            ...
            $('#table-chairperson').on('click', '.btn-activate', function() {
                var id = $(this).data('id')
                var status = $(this).data('status');
